...
import br.com.catalogo.modelo.DadosDoLivro;
...
public class Principal {
    ...
    private void buscarLivro() {
        ...
        List<DadosDoLivro> livrosDTO = converteDados.obterLista(jsonLivro, DadosDoLivro.class);
