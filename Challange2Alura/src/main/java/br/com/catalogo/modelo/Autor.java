...
public class Autor {
    ...
    public Autor(DodosDoAutor dodosDoAutor) {
        this.autor = dodosDoAutor.autor();
        this.anoNascimento = Year.of(dodosDoAutor.anoNascimento());
        this.anoFalecimento = Year.of(dodosDoAutor.anoFalecimento());
    }
