...
public class Livro {
    ...
    public Livro(DadosDoLivro dadosDoLivro) {
        this.titulo = dadosDoLivro.titulo();
        Autor autor = new Autor(dadosDoLivro.authors().get(0));
        this.autor = autor;
        this.idioma = dadosDoLivro.idioma().get(0);
        this.numeroDownload = dadosDoLivro.numeroDownload();
    }
